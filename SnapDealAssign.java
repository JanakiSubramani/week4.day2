...
public class SnapDealAssign {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		WebElement view = driver.findElement(
				By.xpath("(//button[@class='view-more-button btn btn-line btn-theme-secondary viewMoreFilter'])[1]"));
		a.click(view).perform();
		WebElement color = driver.findElement(By.xpath("//label[@for='Color_s-Yellow']"));
		a.click(color).perform();

		// 10.verify the all applied filters,Mouse Hover on first resulting Training
		// shoes
